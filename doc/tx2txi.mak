...
OBJFILES=tx2txi.o
ALL_OBJFILES=tx2txi.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=s:/rho/rhide/doc/rhide.tx rhide.txi
SRC_DIRS=$(RHIDESRC)/doc
WUC=
EDITORS=
MAIN_TARGET=tx2txi
PROJECT_ITEMS=tx2txi.c
DEFAULT_MASK=*.[acfghimnopst]*
...
tx2txi:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=tx2txi.c g:/djgpp/include/limits.h g:/djgpp/include/stdio.h\
	g:/djgpp/include/stdlib.h g:/djgpp/include/string.h\
	g:/djgpp/include/sys/djtypes.h g:/djgpp/include/sys/movedata.h\
	g:/djgpp/include/sys/version.h
tx2txi.o:: $(DEPS_1)
	$(RHIDE_COMPILE.c.o)
all:: tx2txi
