...
# d:/obj/rhide/gpr2mak.exe -d -r- -o - gprexp.gpr
ifeq ($(strip $(RHIDESRC)),)
...
gprexp.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=gprexp.cc ideenums.h libide.h rhide.h rhutils.h tdepende.h tfname.h\
...
nodebobj/ideflags.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cc.o)
DEPS_5=idemak.cc ideenums.h libide.h libtvuti.h rhide.h rhutils.h\
