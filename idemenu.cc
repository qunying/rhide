...
TMenuBar *IDE::initMenuBar( TRect r )
{
  ...
  TMenuItem &syntax_sub = *new TSubMenu(_("~S~yntax help"), kbAlS, hcSyntax)
    +*new _TMenuItem( __("~S~yntax help"), cmSyntaxHelp, kbCtF1, hcSyntaxHelp, "Ctrl+F1")
  ...
  TSubMenu &help_menu = *new TSubMenu( _("~H~elp"), kbAlH , hcHelpMenu )
    ...
    +*new _TMenuItem( __("RHIDE Help ~i~ndex"), cmHelpIndex, kbShF1, hcHelpIndex, "Shift+F1" )
    +     syntax_sub
    ...
    +*new _TMenuItem( __("~L~ast help"), cmLastHelp, kbAlF1, hcLastHelp, "Alt+F1" )
  ;
  ...
  TMenuItem& macro_sub = *new TSubMenu( _("~M~acro"), kbAlM, hcMacro )
    +*new _TMenuItem( __("~R~ecord"), cmcRecordMacro, kbShF10, hcRecord, "Shift+F10" )
    +*new _TMenuItem( __("~S~top"), cmcStopMacro, kbAlF10, hcStop, "Alt+F10" )
    +*new _TMenuItem( __("~P~lay"), cmcPlayMacro, kbCtF10, hcPlay, "Ctrl+F10" )
    +     newLine()
    +*new _TMenuItem( __("~C~hoose"), cmcChooseMacro, kbNoKey, hcChooseMacro)
    +*new _TMenuItem( __("R~e~peat"), cmcRepeatMacro, kbShF3, hcRepeatMacro, "Shift+F3")
  ...
  TSubMenu& edit_menu = *new TSubMenu( _("~E~dit"), kbAlE, hcEdit )
    ...
    +     newLine()
    +*new _TMenuItem( __("Cu~t~"), cmcCut, kbShDelete, hcCut, "Shift+Del" )
    +*new _TMenuItem( __("~C~opy"), cmcCopy, kbCtInsert, hcCopy, "Ctrl+Ins" )
    +*new _TMenuItem( __("~P~aste"), cmcPaste, kbShInsert, hcPaste, "Shift+Ins" )
  ...
  TSubMenu& search_menu = *new TSubMenu( _("~S~earch"), kbAlS, hcSearch )
    ...
    +*new _TMenuItem( __("~G~oto Line..."), cmGotoLine, kbCtJ, hcGotoLine, "Ctrl+J" )
    +*new _TMenuItem( __("~J~ump to function"), cmJumpToFunction, kbAlF2, hcJumpToFunction, "Alt+F2" )
    +     newLine()
    +*new _TMenuItem( __("~N~ext message"), cmNextMessage, kbAlF8, hcNextMessage, "Alt+F8")
    +*new _TMenuItem( __("Previ~o~us message"), cmPrevMessage, kbAlF7, hcPrevMessage, "Alt+F7")
  ;
  ...
  TSubMenu & run_menu = *new TSubMenu( _("~R~un"), kbAlR, hcRunMenu )
    ...
    +*new _TMenuItem( __("Step over (No display swap)"), cmStepNo, kbShF8, hcStepNo, "Shift+F8" )
    +*new _TMenuItem( __("~T~race into"), cmTrace, kbF7, hcTrace, "F7" )
    +*new _TMenuItem( __("Trace into (No display swap)"), cmTraceNo, kbShF7, hcTraceNo, "Shift+F7" )
    +*new _TMenuItem( __("~G~o to cursor"), cmGoto, kbF4, hcGoto, "F4" )
    +*new _TMenuItem( __("Go to cursor (No display swap)"), cmGotoNo, kbShF4, hcGotoNo, "Shift+F4" )
    +*new _TMenuItem( __("~U~ntil return"), cmFinish, kbNoKey, hcFinish)
    +*new _TMenuItem( __("~P~rogram reset"), cmReset, kbCtF2, hcReset, "Ctrl+F2" )
    +      newLine()
  ...
  TSubMenu& compile_menu = *new TSubMenu( _("~C~ompile"), kbAlC, hcCompileMenu )
    +*new _TMenuItem( __("~C~ompile"), cmCompile, kbAlF9, hcCompile, "Alt+F9" )
  ...
  TSubMenu& project_menu = *new TSubMenu( _("~P~roject"), kbAlP,hcProjectMenu )
  ...
  ;
  TSubMenu& window_menu = *new TSubMenu( _("~W~indows"), kbAlW, hcWindows )
    +*new _TMenuItem( __("~S~ize/move"), cmResize, kbCtF5, hcResize, "Ctrl+F5" )
    ...
    +*new _TMenuItem( __("~P~revious"), cmPrev, kbShF6, hcPrev, "Shift+F6" )
    +*new _TMenuItem( __("~C~lose"), cmClose, kbAlF3, hcClose, "Alt+F3" )
    +*new _TMenuItem( __("~L~ist"), cmShowWindowList, kbAl0, hcShowWindowList, "Alt+0" )
    +     newLine()
    ...
    +*new _TMenuItem( __("~U~serScreen"), cmUserScreen, kbAlF5, hcUserScreen, "Alt+F5" )
  ;
  ...
  TSubMenu& space_menu = *new TSubMenu( _("~ð~"), kbAlSpace )
    ...
    +     newLine()
    +*new _TMenuItem( __("~C~alculator"), cmShowCalculator, kbAlF4, hcShowCalculator, "Alt+F4" )
  ...
  TSubMenu& debug_menu = *new TSubMenu( _("~D~ebug"), kbAlD, hcDebug )
    +*new _TMenuItem( __("~S~et/Reset Breakpoint"), cmToggleBreak, kbCtF8, hcToggleBreak, "Ctrl+F8" )
    +*new _TMenuItem( __("~E~valuate/Modify"), cmEvaluate, kbCtF4, hcEvaluate, "Ctrl+F4" )
    +*new _TMenuItem( __("~W~atch an expression"), cmAddWatchEntry, kbCtF7, hcAddWatchEntry, "Ctrl+F7" )
    +*new _TMenuItem( __("~I~nspect an expression"), cmInspect, kbCtF6, hcInspect, "Ctrl+F6" )
