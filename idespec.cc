...
#define SAME_LIBS(x,y)\
 ...
 "RHIDE_COMPILE_PASCAL_AUTOMAKE",
 "$(RHIDE_COMPILE_$(PASCAL_TYPE)_AUTOMAKE)",

 "RHIDE_LINK_PASCAL",
 "$(RHIDE_LINK_$(PASCAL_TYPE))",
 ...
 "$(RHIDE_LD) $(RHIDE_LIBDIRS) $(C_EXTRA_FLAGS) -o $(OUTFILE)\
  $(RHIDE_ADA_BIND_FILE) $(OBJFILES) $(LIBRARIES) $(RHIDE_LIBS) $(LDFLAGS)\
  $(RHIDE_LDFLAGS)",
 ...
 "gnatbl $(RHIDE_LIBDIRS) $(C_EXTRA_FLAGS) -o $(OUTFILE)\
  $(setsuffix .ali,$(OUTFILE)) $(LIBRARIES) $(RHIDE_LIBS) $(LDFLAGS)\
  $(RHIDE_LDFLAGS)",
