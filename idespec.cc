...
#define SAME_LIBS(x,y)\
 ...
 "$(RHIDE_GCC) $(RHIDE_INCLUDES) $(C_DEBUG_FLAGS) $(C_OPT_FLAGS)\
  $(C_WARN_FLAGS) $(C_C_LANG_FLAGS) $(C_EXTRA_FLAGS) $(CPPFLAGS) \
  $(CFLAGS) $(RHIDE_OS_CFLAGS) $(LOCAL_OPT) -c $(SOURCE_NAME) -o $(OUTFILE)",

 "RHIDE_COMPILE_C_FORCE",
 "$(RHIDE_GCC) $(RHIDE_INCLUDES) $(C_DEBUG_FLAGS) $(C_OPT_FLAGS)\
  $(C_WARN_FLAGS) $(C_C_LANG_FLAGS) $(C_EXTRA_FLAGS) -x c $(CPPFLAGS)\
  $(CFLAGS) $(RHIDE_OS_CFLAGS) $(LOCAL_OPT) -c $(SOURCE_NAME) -o $(OUTFILE)",
