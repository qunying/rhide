...
vpath_header=$(RHIDESRC)/libide/include $(RHIDESRC)/libtvuti/include\
	$(TVSRC)/include $(SETSRC)/include $(SETSRC)/settvuti/include
...
OBJFILES=sdepcoll.o sdepende.o sflagcol.o sflagent.o sideedit.o sidefile.o\
	soptions.o sproject.o
ALL_OBJFILES=sdepcoll.o sdepende.o sflagcol.o sflagent.o sideedit.o\
	sidefile.o soptions.o sproject.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=
SRC_DIRS=$(RHIDESRC)/libide/stream
WUC=
EDITORS=
MAIN_TARGET=
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= sdepcoll.o sdepende.o sflagcol.o sflagent.o sideedit.o sidefile.o\
	soptions.o sproject.o 
NO_LINK=
