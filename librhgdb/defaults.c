...
static void __DebuggerScreen(void)
{
}

void (*_DebuggerScreen)(void) = __DebuggerScreen;

static int __DoMake(void)
{
  return 1;
}
...
static char *__GetProgName(void)
{
  return 0;
}
...
static char **__GetProgramArguments(int *count)
{
  *count = 0;
  return 0;
}
...
static char **__GetSourceDirectories(int *count)
{
  *count = 0;
  return 0;
}
...
static void __InitGDBOutWin(void)
{
}
...
static void __StartSession(void)
{
}
...
static void __BreakSession(void)
{
}

void (*_BreakSession)(void) = __BreakSession;

static char *__GetMainFunction()
{
  return "main";
}
