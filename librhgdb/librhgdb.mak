...
# d:/obj/rhide/gpr2mak.exe -d -r- -o __tmp__.mak librhgdb.gpr
ifeq ($(strip $(GDB_OBJ)),)
...
RHIDE_COMPILE_ARCHIVE=$(RHIDE_COMPILE_LINK)
RHIDE_STDINC_C_DJGPP=$(DJDIR)/include
RHIDE_STDINC_CXX_DJGPP=$(DJDIR)/lang/cxx 
RHIDE_STDINC_GCC_DJGPP=$(DJDIR)/lib
RHIDE_STDINC_C_Linux=/usr/include /usr/local/include
...
LIB_DIRS=$(GDB_OBJ)/gdb $(GDB_OBJ)/bfd $(GDB_OBJ)/opcodes\
	$(GDB_OBJ)/libiberty $(GDB_OBJ)/readline
C_DEBUG_FLAGS=-g
C_OPT_FLAGS=-O2
C_WARN_FLAGS=
C_C_LANG_FLAGS=
