...
# ../../gpr2mak.exe -d -r- -o - o:/rhide/librhgdb/test/gsymify.gpr
ifeq ($(strip $(RHIDESRC)),)
...
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=-i c:/tmp/g c:/tmp/g.exe
...
PROJECT_ITEMS=gdbdummy.c ../librhgdb.gpr symify.c
DEFAULT_MASK=*.gpr
...
gsymify.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=gdbdummy.c e:/djgpp.202/include/stdio.h\
	$(DJDIR).202/include/string.h e:/djgpp.202/include/sys/djtypes.h\
	$(DJDIR).202/include/sys/movedata.h
gdbdummy.o:: $(DEPS_1)
	$(RHIDE_COMPILE.c.o)
DEPS_2=
...
DEPS_3=symify.c ../../libgdb/libgdb.h e:/djgpp.202/include/inlines/pc.h\
	$(DJDIR).202/include/pc.h e:/djgpp.202/include/stdio.h\
