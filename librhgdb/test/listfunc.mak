...
# ../../gpr2mak.exe -d -r- -o - o:/rhide/librhgdb/test/listfunc.gpr
ifeq ($(strip $(RHIDESRC)),)
...
DEPS_2=listfunc.c ../../libgdb/libgdb.h e:/djgpp.202/include/stdio.h\
	$(DJDIR).202/include/stdlib.h e:/djgpp.202/include/string.h\
	$(DJDIR).202/include/sys/djtypes.h e:/djgpp.202/include/sys/types.h\
	$(DJDIR).202/include/unistd.h\
