...
# gpr2mak -d -r- -o - mygdb.gpr
vpath_src=$(RHIDESRC)/librhgdb/test
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
SPECIAL_LDFLAGS=
PROG_ARGS=mygdb.exe
SRC_DIRS=$(RHIDESRC)/librhgdb/test
WUC=
EDITORS=
MAIN_TARGET=mygdb.exe
PROJECT_ITEMS=../librhgdb.gpr mygdb.c
DEFAULT_MASK=*.[cho]*
