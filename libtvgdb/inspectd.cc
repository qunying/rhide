...
TInspectDialog::TInspectDialog(const TRect & bounds, char *Title, char *StartVal)
  : TDialog(bounds,Title),
  TWindowInit(TInspectDialog::initFrame)
{
  TRect r;
...
void TInspectDialog::handleEvent(TEvent & event)
{
