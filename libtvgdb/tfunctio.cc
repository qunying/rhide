...
void *TFunctionCollection::keyOf(void *item)
{
...
int TFunctionCollection::compare(void *key1,void *key2)
{
...
TFunctionListBox::TFunctionListBox( 
       const TRect& bounds, ushort aNumCols, TScrollBar *aScrollBar,
       const char *regex) :
...
void TFunctionListBox::getText(char *dest,ccIndex item,short maxlen)
{
...
void TFunctionListBox::handleEvent(TEvent &event)
{
...
void TFunctionListBox::selectItem(ccIndex item)
{
