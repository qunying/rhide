...
# d:/obj/rhide/gpr2mak.exe -d -r- -o dÒ rhgdb.gpr
ifeq ($(strip $(PCRE_OBJ)),)
PCRE_OBJ=
endif
ifeq ($(strip $(RHIDESRC)),)
...
C_F_LANG_FLAGS=
C_ADA_LANG_FLAGS=
LIBS=tvgdb rhgdb rhuti set tvuti rhuti rhtv gdb z pcre
LD_EXTRA_FLAGS=
...
ALL_OBJFILES=gdbedit.o gdbsynt.o main.o options.o version.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=c:/temp/em/emacs-20.3/src/emacs
SRC_DIRS=$(RHIDESRC)/rhgdb
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
ifeq ($(strip $(RHIDE_OS)),)
