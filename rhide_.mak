...
# d:/obj/rhide/gpr2mak.exe -d -r- -o __tmp__.mak rhide_.gpr
ifeq ($(strip $(PCRE_OBJ)),)
PCRE_OBJ=
endif
ifeq ($(strip $(RHIDESRC)),)
...
C_F_LANG_FLAGS=
C_ADA_LANG_FLAGS=
LIBS=ide rhuti set tvdem tvuti rhtv z pcre
LD_EXTRA_FLAGS=
...
ide.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=commands.cc ideconst.h rhide.h libtvuti.h tvutilfu.h
