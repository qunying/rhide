...
OBJFILES=nodebobj/tocrlf.o
ALL_OBJFILES=librhuti/abstorel.o librhuti/back2sl.o librhuti/basename.o\
	librhuti/fexpand.o librhuti/fixpath.o librhuti/getline.o\
	librhuti/io.o librhuti/specs.o librhuti/splitfn.o\
	librhuti/stricat.o librhuti/stridown.o librhuti/stridup.o\
	librhuti/strifree.o nodebobj/tocrlf.o
...
WUC=
EDITORS=
MAIN_TARGET=tocrlf.exe
PROJECT_ITEMS=librhuti/librhuti.gpr tolf.cc
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= nodebobj/tocrlf.o librhuti/librhuti.a
NO_LINK=
...
DEPS_2=tolf.cc rhutils.h
nodebobj/tocrlf.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cc.o)
LOCAL_2=\
	tolf.cc___-DTOCRLF
