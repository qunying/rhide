...
# ../gpr2mak.exe -d -r- -o - libtvdem.gpr
ifeq ($(strip $(RHIDESRC)),)
...
RHIDE_OS_CXXFLAGS=$(RHIDE_OS_CXXFLAGS_$(RHIDE_OS)) -fno-exceptions -fno-rtti\
	-funsigned-char
INCLUDE_DIRS=$(RHIDESRC)/tvdemo/include $(RHIDESRC)/tvision/include
LIB_DIRS=
C_DEBUG_FLAGS=-g
C_OPT_FLAGS=-O2
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=ascii.o calendar.o libtvdem.o mousedlg.o puzzle.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
%.s: %.C
	$(RHIDE_COMPILE.C.s)
all::
DEPS_0= ascii.o calendar.o libtvdem.o mousedlg.o puzzle.o 
NO_LINK=
